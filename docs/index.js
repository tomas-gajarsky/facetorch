...
{
"ref":"facetorch.transforms.optimize_transform",
"url":19,
"doc":"Convert the composed transform to a TorchScript module. Args: transform (transforms.Compose): Transform compose object to be scripted. device (torch.device): Torch device cpu or cuda. Returns: Union[torch.jit.ScriptModule, torch.jit.ScriptFunction]: Scripted transform.",
"func":1
},
{
...
{
"ref":"facetorch.utils.read_version",
"url":20,
"doc":"Read version from file. Args: filename (str): Path to the file. Returns: str: Version of the package.",
"func":1
},
{
